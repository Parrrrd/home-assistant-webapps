...
function page() {
  return String.raw`<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><title>Einkaufsliste</title><meta name="application-name" content="Einkaufsliste"><meta name="apple-mobile-web-app-title" content="Einkaufsliste"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="default"><meta name="theme-color" content="#3f7f2d"><meta name="mobile-web-app-capable" content="yes"><link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png?v=0.3.55"><link rel="apple-touch-icon-precomposed" sizes="180x180" href="apple-touch-icon-precomposed.png?v=0.3.55"><link rel="icon" type="image/png" sizes="64x64" href="favicon-64.png?v=0.3.55"><link rel="shortcut icon" type="image/png" href="favicon-64.png?v=0.3.55"><link rel="manifest" href="manifest.webmanifest?v=0.3.55"><style>
