...
APP_NAME = "MOVA OG Protokoll"
DATA_ROOT = Path(os.environ.get("DATA_ROOT", "/data")) / "mova_og_protokoll"
...
DEFAULTS = {
    "camera_entity": "camera.mova_e20_plus_map",
    "mower_entity": "sensor.mova_e20_plus_task_status",
    "duration_entity": "",
    "mode_entity": "sensor.mova_e20_plus_task_status",
    "retain_count": 20,
    "poll_seconds": 5,
...
def start_monitor() -> None:
    ...
    if monitor_thread and monitor_thread.is_alive():
        return
    monitor_thread = threading.Thread(target=monitor.run, name="mova-og-monitor", daemon=True)
